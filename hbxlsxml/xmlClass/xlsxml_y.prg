...
CREATE CLASS ExcelWriterXML_Style 
   ...
   DATA   borderTop                               INIT hb_hash()
   DATA   borderBottom                            INIT hb_hash()
   DATA   borderLeft                              INIT hb_hash()
   DATA   borderRight                             INIT hb_hash()
   DATA   borderDL                                INIT hb_hash()
   DATA   borderDR                                INIT hb_hash()
   ...
   DATA   namedColorsIE                           INIT hb_hash()
...
METHOD ExcelWriterXML_Style:getStyleXML()  
   ...
   IF ::useBorder 
      ...
      positions := hb_hash()
      positions[ 'Top'           ] := ::borderTop
      positions[ 'Bottom'        ] := ::borderBottom
      positions[ 'Left'          ] := ::borderLeft
      positions[ 'Right'         ] := ::borderRight
      positions[ 'DiagonalLeft'  ] := ::borderDL
      positions[ 'DiagonalRight' ] := ::borderDR
      auxdata := NIL
