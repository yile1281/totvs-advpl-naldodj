...
{
	param(
			[string]$totvsTarget	= "C:\Protheus10_PROD\Protheus_Data\system_services\",
			[string]$totvsSource	= "C:\Protheus10_PROD\Protheus_Data\system\",
			[string]$DisplayName 	= "PROTHEUS 10 SERVICOS"
		)	
