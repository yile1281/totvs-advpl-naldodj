...
*   oPDF:CloseHeader()
   ...
   oPDF:Image( cTempPath+"BlackTDNBlog_1246_212_r1.JPG", 15, 0, "M" , 25 , oPDF:WIDTH() ) // file, row, col, units, height, width
   ...
   oPDF:Text(OemToAnsi("Como o tempo era de manga eu cai da bicicleta") ,8,5,oPDF:WIDTH(),0,1,"",oPDF:Colorize(oPDF:rgbToHex(150,20,60)))
