	...
	#xcommand PARAMTYPE [ <param> VAR ] <varname> AS <type: ARRAY,BLOCK,CHARACTER,DATE,NUMERIC,NUMBER,LOGICAL,LOGIC,OBJECT,UNDEFINED> ;
		[ , <typeN: ARRAY,BLOCK,CHARACTER,DATE,NUMERIC,NUMBER,LOGICAL,LOGIC,OBJECT,UNDEFINED> ] ;
		[ MESSAGE <message> ] ;
		[ <optional: OPTIONAL> ] ;
		[ DEFAULT <uVar> ] ;
		=> ;
	...
	#xcommand PARAMTYPE [ <param> VAR ] <varname> AS BLOCK EXPECTED <expected: ARRAY,BLOCK,CHARACTER,DATE,NUMERIC,NUMBER,LOGICAL,LOGIC,OBJECT,UNDEFINED> ;
		[ MESSAGE <message> ] ;
		[ <optional: OPTIONAL> ] ;
		=> ;
	...
	#xcommand PARAMTYPE [ <param> VAR ] <varname> AS <type: ARRAY,BLOCK,CHARACTER,DATE,NUMERIC,NUMBER,LOGICAL,LOGIC,UNDEFINED> ;
		[ , <typeN: ARRAY,BLOCK,CHARACTER,DATE,NUMERIC,NUMBER,LOGICAL,LOGIC,UNDEFINED> ] ;
		...
		*/
		...
		#xcommand LOCAL <varname> AS <type:ARRAY,BLOCK,CHARACTER,DATE,NUMERIC,NUMBER,LOGICAL,OBJECT,UNDEFINED>;
		[CLASS <classname>];
		[MESSAGE <message>];
		[VALUE <uVal>];
		=> ;
		...
		#xcommand STATIC <varname> AS <type:ARRAY,BLOCK,CHARACTER,DATE,NUMERIC,NUMBER,LOGICAL,OBJECT,UNDEFINED>;
		[CLASS <classname>];
		[MESSAGE <message>];
		[VALUE <uVal>];
		=> ;
		...
		#xcommand PUBLIC <varname> AS <type:ARRAY,BLOCK,CHARACTER,DATE,NUMERIC,NUMBER,LOGICAL,OBJECT,UNDEFINED>;
		[CLASS <classname>];
		[MESSAGE <message>];
		[VALUE <uVal>];
		=> ;
		...
		#xcommand PRIVATE <varname> AS <type:ARRAY,BLOCK,CHARACTER,DATE,NUMERIC,NUMBER,LOGICAL,OBJECT,UNDEFINED>;
		[CLASS <classname>];
		[MESSAGE <message>];
		[VALUE <uVal>];
		=> ;
