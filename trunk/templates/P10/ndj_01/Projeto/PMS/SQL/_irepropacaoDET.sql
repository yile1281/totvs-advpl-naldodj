  ...
  FROM ( SELECT AF8.AF8_PROJET ,
                 ...
                 (SELECT AJC.AJC_PROJET  D1_XPROJET,
				  ...
				  SELECT SD1A.D1_XPROJET,
					     ...
					     FROM ( SELECT SD1B.D1_XPROJET,
                                ...
                                GROUP BY SD1B.D1_XPROJET, SD1B.D1_XREVIS , SD1B.D1_XCODOR , SD1B.D1_XTAREFA,
					                     SD1B.D1_XCODSBM, SD1B.D1_FORNECE, SD1B.D1_LOJA   , SD1B.D1_DTDIGIT,
					                     SD1B.D1_SERIE  , SD1B.D1_DOC    , SD1B.D1_FORNECE, SD1B.D1_LOJA   ,
                                         SE2.E2_PREFIXO , SE2.E2_NUM     , SE2.E2_FORNECE , SE2.E2_LOJA ) AS SD1A
         ...
         GROUP BY AF8.AF8_PROJET ,
                  ...
                  AFB.AFB_TAREFA
			              ...
			              PROJ_TAREFA.AF8_XCODOR = TOTAIS_PROJ_PREV.AF8_XCODOR AND
