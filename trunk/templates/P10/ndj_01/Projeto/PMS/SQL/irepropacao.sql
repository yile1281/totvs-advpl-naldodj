...
SELECT AF1_ORCAME,
       ...
       ( CASE ISNULL( ( SELECT 1 WHERE dbo.FormatDinheiro( PREVTOTORC ) = dbo.FormatDinheiro( PREVTOTPROJ ) ), 0 )
              WHEN 0
              THEN 'OS PREVISTOS DO ORÇAMENTO (' + dbo.FormatDinheiro( PREVTOTORC ) + ') E DO PROJETO (' + dbo.FormatDinheiro( PREVTOTPROJ ) + ') NÃO ESTÃO IGUAIS, FAVOR VERIFICAR E ENTRAR EM CONTATO COM A CONTROLADORIA.'
              ELSE ''
         END ) ALERTA,
...
SELECT AF1.AF1_ORCAME,
       ...
       ( SELECT SUM( SD1TOTAL ) AS SD1TOTAL
                  FROM ( SELECT SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
                                SE2.E2_PREFIXO,SE2.E2_NUM,SE2.E2_FORNECE,SE2.E2_LOJA,                            
                                ( SUM( SD1.D1_TOTAL ) + SUM( SE2.E2_ACRESC - SE2.E2_DECRESC ) ) AS SD1TOTAL
						   FROM SD1010 AS SD1
								LEFT JOIN
								SE2010 AS SE2 ON SE2.E2_PREFIXO = SD1.D1_SERIE   AND
						  ...
						  WHERE SD1.D_E_L_E_T_  = ''
							...
							AND SE2.D_E_L_E_T_  = ''
							AND SE2.E2_BAIXA   >= @DATAINI 
							AND SE2.E2_BAIXA   <= @DATAFIN 
                         GROUP BY SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
                                  SE2.E2_PREFIXO,SE2.E2_NUM,SE2.E2_FORNECE,SE2.E2_LOJA ) AS SD1T1 ) AS 'REALPESJUR',
       ...
       ( SELECT SUM( SD1TOTAL ) AS SD1TOTAL
                  FROM ( SELECT SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
						  ...
						  WHERE SD1.D_E_L_E_T_  = ''
							...
							AND SE2.E2_BAIXA   <= @DATAFIN 
                         GROUP BY SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
                                  SE2.E2_PREFIXO,SE2.E2_NUM,SE2.E2_FORNECE,SE2.E2_LOJA ) AS SD1T2 ) AS 'REALPESSOAL',
       ...
       ( SELECT SUM( SD1TOTAL ) AS SD1TOTAL
                  FROM ( SELECT SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
						  ...
						  WHERE SD1.D_E_L_E_T_  = ''
							...
							AND SE2.E2_BAIXA   <= @DATAFIN 
                         GROUP BY SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
                                  SE2.E2_PREFIXO,SE2.E2_NUM,SE2.E2_FORNECE,SE2.E2_LOJA ) AS SD1T2 ) AS 'REALPESFIS',
       ...
       ( SELECT SUM( SD1TOTAL ) AS SD1TOTAL
                  FROM ( SELECT SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
						  ...
						  WHERE SD1.D_E_L_E_T_  = ''
							...
							AND SE2.E2_BAIXA   <= @DATAFIN 
                         GROUP BY SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
                                  SE2.E2_PREFIXO,SE2.E2_NUM,SE2.E2_FORNECE,SE2.E2_LOJA ) AS SD1T4 ) AS 'REALOPERADM',
       ...
       ( SELECT SUM( SD1TOTAL ) AS SD1TOTAL
                  FROM ( SELECT SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
						  ...
						  WHERE SD1.D_E_L_E_T_  = ''
							...
							AND SD1.D1_XPROJET  = AF8.AF8_PROJET
							AND SD1.D1_XREVIS   = AF8.AF8_REVISA 
							AND D1_XCODSBM IN ( 'MU', 'HW', 'MA', 'SW', 'BO' )
							AND SE2.D_E_L_E_T_  = ''
							AND SE2.E2_BAIXA   >= @DATAINI 
							AND SE2.E2_BAIXA   <= @DATAFIN 
                         GROUP BY SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
                                  SE2.E2_PREFIXO,SE2.E2_NUM,SE2.E2_FORNECE,SE2.E2_LOJA ) AS SD1T5 ) AS 'REALCAPITAL',
       ...
       ( SELECT SUM( SD1TOTAL ) AS SD1TOTAL
                  FROM ( SELECT SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
						  ...
						  WHERE SD1.D_E_L_E_T_  = ''
							...
							AND SE2.E2_BAIXA   <= @DATAFIN 
                         GROUP BY SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
                                  SE2.E2_PREFIXO,SE2.E2_NUM,SE2.E2_FORNECE,SE2.E2_LOJA ) AS SD1T6 ) AS 'REALVIAGEM',
       ...
       ( SELECT SUM( SD1TOTAL ) AS SD1TOTAL
                  FROM ( SELECT SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
						  ...
						  WHERE SD1.D_E_L_E_T_  = ''
							...
							AND SE2.E2_BAIXA   <= @DATAFIN 
                         GROUP BY SD1.D1_SERIE  ,SD1.D1_DOC,SD1.D1_FORNECE,SD1.D1_LOJA, 
                                  SE2.E2_PREFIXO,SE2.E2_NUM,SE2.E2_FORNECE,SE2.E2_LOJA ) AS SD1T7 ) AS 'REALTOTORC',
